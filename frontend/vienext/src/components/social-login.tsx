  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative flex items-center py-2">
        ...
        <span className="mx-4 flex-shrink text-xs text-slate-500 dark:text-slate-400">{t.orContinueWith}</span>
        <div className="flex-grow border-t border-slate-200 dark:border-slate-700"></div>
      </div>

      <p className="text-center text-sm text-slate-500 dark:text-slate-400">{t.socialLoginInfo}</p>
    </div>
  )
}
